...
#define EV_REGEN_TORQUE_MAX_NM   80.0f  // is it negative?
#define EV_REGEN_THRESHOLD_PCT    5.0f  // regenerative threshold
#define EV_BATTERY_CAPACITY_KWH  60.0f
#define EV_MASS_FACTOR         500.0f // is it the car mass?
#define EV_MAX_SPEED_KMH        200.0f
#define EV_MAX_MOTOR_TEMP_C      90.0f
#define EV_FAULT_SOC_PCT          2.0f // if charge < 2% ,--> fault
...
//#define EV_EFFICIENCY_ECO    14.0f // for Eco mode 14wh/km
//#define EV_EFFICIENCY_OTHER  18.0f // for normal and the sport mode

#define EV_EFFICIENCY_ECO    130.0f
#define EV_EFFICIENCY_OTHER  160.0f
