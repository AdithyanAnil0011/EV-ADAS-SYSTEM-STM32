...
// waits for atmost 30ms for the echo signal(if not received -->TIMEOUT)

#define HCSR04_TRIG_PULSE_US      10UL  /* 10 µs TRIG pulse                 */

#define HCSR04_INTER_SENSOR_US 30000UL
//DELAY BeT SENSORS-->if multiple sensors trigg simul can cause cross talk
//Therefore Sen A->Measure->finish->30ms->Sen B->Measure->finsh->30ms->......
